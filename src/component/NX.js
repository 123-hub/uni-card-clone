      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        ...
        <div className="flex flex-col md:flex-row-reverse mx-auto max-w-[1280px] w-full justify-center z-10 bg-transparent">
          <img
            ...
            alt="card_asset"
            className="h-auto w-[225px] md:w-[420px] md:h-[420px] max-w-[420px] z-10 mx-6"
          />
          <div className="z-20 w-full mt-7 md:mt-0 md:my-auto flex flex-col self-end md:self-center px-6">
